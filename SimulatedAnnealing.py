...
def split_cells(im, cells):
    ...
    for cell in cells:
        ...
        if len(minima)>0:
            ...
            if depth[didx]>0.2 and abs(idx-len(profile)/2)/len(profile)<0.25:

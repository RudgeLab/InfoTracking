...
#fname = '../Microscopy/10x_1.0x_pLPT20_MC_TiMain_1_MMStack_Pos1.ome.tif'
#fname = '../Microscopy/10x_1.5x_-5_pAAA_MG_1_MMStack_Pos9.ome.tif'
...
#fname = '../Microscopy/10x_1.0x_pLPT20_DHL_1_MMStack_Pos4.ome (1).tif'
#fname = '../Microscopy/10x_1.0x_pLPT20_DHL_TiMain_1_MMStack_Pos5.ome.tif'
#fname = '../Microscopy/10x_1.0x_-.5div2_pLPT20_MC_TiTweez_1_MMStack_Pos7.ome.tif'
fname = '/Volumes/General/Microscopy/200723/Tweez2/10x_1.0x_pLPT20&41_DHL_TiTweez_2_MMStack_Pos4.ome.tif'
im_all = imread(fname)
print(im_all.shape)
...
for t in range(nt):
    ...
    snake = active_contour(gaussian(f, 3, preserve_range=False),
                       init, alpha=5e-3, beta=1e-6, gamma=0.001, w_edge=1 + t/20, w_line=0)
...
#imsave('10x_1.0x_pLPT20_DHL_1_MMStack_Pos4.ome (1).contour.mask.tif', mask_out>0)
...
#imsave('10x_1.5x_-5_pAAA_MG_1_MMStack_Pos9.ome.contour.mask.tif', mask_out>0)
#imsave('10x_1.0x_pLPT20_MC_TiMain_1_MMStack_Pos1.ome.contour.mask.tif', mask_out>0)
#imsave('10x_1.0x_-.5div2_pLPT20_MC_TiTweez_1_MMStack_Pos7.ome.contour.mask.tif', mask_out>0)
imsave('/Volumes/General/Microscopy/200723/Tweez2/10x_1.0x_pLPT20&41_DHL_TiTweez_2_MMStack_Pos4.ome.tif', mask_out>0)

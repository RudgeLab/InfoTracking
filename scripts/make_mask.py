...
weka = imread('C2-10x_1.5x_-5_pAAA_MG_1_MMStack_Pos8_phase.weka.ome.tif')
...
for frame in range(nt):
    ...
    mask[frame,:,:] = area_closing(mask[frame,:,:], area_threshold=4096)

# Save final mask
imsave('C2-10x_1.5x_-5_pAAA_MG_1_MMStack_Pos8_phase.mask.ome.tif', mask)
